...
<button type="submit" name="submit">Login</button> &nbsp;<a href="<?php echo base_url();?>index.php/admin/forgotpassword" style="font-size:13px; margin-top:5px;">Forgot Password</a>
</form>
</div>
</div>
