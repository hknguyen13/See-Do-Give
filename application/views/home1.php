...
<span style="float:left; display:block; margin-top:-80px; margin-left:150px; color:#000000;"><a href="<?php echo base_url(); ?>index.php/user/viewuser" style="margin-left:600px; color:#FFFFFF;"><?php echo $name;?></a> | <a href="<?php echo base_url(); ?>index.php/user/logout" style="color:#FFFFFF;">Logout</a></span>
<div class="clear"></div>
</div>
</div>
<!--header Finish Here-->
...
<button type="button" onclick="suresh();" style=" height: 37px; margin-left:80px; margin-top:20px; width:100px;">Give</button>
...
<a href="<?php echo base_url();?>index.php/user/home1/<?php echo $val->bcbroadcaster_id;?>"><img src="<?php echo base_url();?>images/<?php echo $val->bc_videoimage;?>" /></a><?php endforeach;?>	
<form action="" method="post">
<input type="hidden" name="facebook_id" value="<?php echo $this->session->userdata['uid'];?>"  />
</form><?php } ?>
