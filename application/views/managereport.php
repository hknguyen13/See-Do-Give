...
<script type="text/javascript">
	...
	if(fromdate=="" || todate=="")
	{
	alert("Please,give the fromdate and todate");
	return false;
	}
	}
	</script>
...
<div id="header">
	 <?php include("menu.php"); ?>
	  ...
	  <div id="images">
	  <?php if($type=="super") {?><table style="float:left;">
...
<label for="bname">Broadcaster Name
</label>
<select name="bname" id="bname">
<?php foreach($broadcaster as $vals): ?>
<option value="<?php echo $vals->broadcaster_id;?>"><?php echo $vals->broadcaster_name;?></option>
<?php endforeach;?>
</select>
<label>From Date</label>
<input type="text" name="fromdate" id="fromdate" value="" size="40" required="required">
<label>To Date</label>
<input type="text" name="todate" id="todate" value="" size="40" required="required">
