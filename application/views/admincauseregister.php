...
<div id="header">
	 <?php include("menu.php"); ?>
	  ...
	  <div class="bc_menu" style="height:30px;"><?php if($type=="super") { ?><ul id="bc_menu"><li><a href="<?php echo base_url();?>index.php/admin/viewcause" >View Cause</a></li><li><a href="<?php echo base_url();?>index.php/admin/addcause" >Add cause</a></li><li><a href="<?php echo base_url();?>index.php/admin/admincauseregister" <?php if (strpos($_SERVER['PHP_SELF'], "admin/admincauseregister")) { echo 'class="active"'; }?>>Add Cause Admin</a></li></ul><?php } ?></div>
<div id="stylized" class="myform">
<form action="" method="post" id="form" name="form">
<h1>Add New Cause Admin</h1>
<p><?php
...
?></p>
<label for="">Admin for Cause
</label>
<select name="adminctype">
<option value=" ">Select</option>
<?php foreach($causes as $vals): ?>
<option value="<?php echo $vals->cause_name;?>"><?php echo $vals->cause_name;?></option>
<?php endforeach;?>
</select>
<label for="">Firstname
</label>
...
<input type="password" name="password" id="password" value="<?php echo $adminvalues['admin_password'];?>" required="required"/>
