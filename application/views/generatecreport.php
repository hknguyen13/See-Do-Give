...
<table width="800" cellspacing="1">
        <tr>
          ...
          <td bgcolor="#CCCCCC" class="adminView">Broadcaster Email</td>
        ...
        <tr>
          ...
          <td align="center" style="font-size:12px;" bgcolor="#eff4fa"><?php echo $vals->broadcaster_name;?></td>
          <td align="center" style="font-size:12px;" bgcolor="#eff4fa"><?php echo $vals->broadcaster_email;?></td>
		  <td align="center" style="font-size:12px;" bgcolor="#eff4fa"><?php echo $vals->userfirstname;?></td>
		  <td align="center" style="font-size:12px;" bgcolor="#eff4fa"><?php echo $vals->amount;?></td>
        </tr>
        <?php endforeach;?>
      </table>
	  <p style="margin-left:745px;"><button type="button" name="submit" class="button1" onClick="location.href='<?=base_url();?>index.php/admin/managecausereports'">Back</button></p>
	    </div>
</div>
</div>
