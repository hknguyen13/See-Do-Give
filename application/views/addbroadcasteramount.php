...
var broadcasterid = $("#bsa_broadcasterid").val();
if(isNaN(amount))
{
alert("Seed must be numbers");
$('#amount').val('');
$('#amount').focus(); 
}
//alert(broadcasterid);
...
{
$.post("<?php echo base_url();?>index.php/admin/seedcal",{Amount:amount,bid:broadcasterid},function(data){
$('input[name*="seeds"]').val(data);
});
}
});
});
...
<div class="bc_menu" style="height:30px;"><ul id="bc_menu"><li><a href="<?php echo base_url();?>index.php/admin/viewbroadcaster">View Broadcaster</a></li><li><a href="<?php echo base_url();?>index.php/admin/addbroadcaster">Add Broadcaster</a></li><li><a href="<?php echo base_url();?>index.php/admin/adminstaffregister">Add Broadcaster Admin</a></li><li><a href="<?php echo base_url();?>index.php/admin/manageseeds">Seed Configration</a></li><li><a href="<?php echo base_url();?>index.php/admin/broadcasterdeposit" <?php if (strpos($_SERVER['PHP_SELF'], "admin/broadcasterdeposit")) { echo 'class="active"'; }?> >Add Amount</a></li><li><a href="<?php echo base_url();?>index.php/admin/addvideos">Add Video</a></li></ul></div>
...
<option value="<?php echo $vals->broadcaster_id;?>" <?php if($amount['bsa_broadcasterid']==$vals->broadcaster_id) { echo "selected=selected"; }?>><?php echo $vals->broadcaster_name;?></option>
<?php endforeach; ?>
</select>
...
<input type="text" name="seeds" id="seeds" value="<?php echo $amount['bsa_seedvalue'];?>" required="required"/>
