<?php
session_start();
define('YOUR_APP_ID', '437151896301252');
define('YOUR_APP_SECRET', '3faeedba2c991b72fe78ce0ad9c91a2d');
...
<a href="http://sritcs.net/demos/seedogive/index.php/user/facebooklogins/<?php echo $val->bcbroadcaster_id;?>"><img src="<?php echo base_url();?>images/<?php echo $val->bc_videoimage;?>" /></a><?php endforeach;?>	<?php } ?>
